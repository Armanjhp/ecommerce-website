...
<body>
			...
			<div class="rbd-review-slider">
				<div class="rbd-review-container">
					<div class="rbd-review review1.1 rbd-curr">
						...
						<i class="fa fa-star"></i>
						<i class="fa fa-star"></i>
						<div class="rbd-content"><img class="rbd-gravatar" src="about-images/user-1.png">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever</div>
					...
					<div class="rbd-review review1.2 rbd-next">
						...
						<div class="rbd-content"><img class="rbd-gravatar" src="about-images/user-2.png">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever</div>
	...
	<div class="content">
		<div class="container">
    			...
    			<div class="col-2">
					<img src="about-images/about.jpg">
				</div>
			<div class="intro">
			...
			<div class="culture">
				...
				<img src="about-images/culture.jpg">
			...
			<div class="corporate-citizenship">
				...
				<img src="about-images/community.jpg">
			</div>
		</div>
	</div>
